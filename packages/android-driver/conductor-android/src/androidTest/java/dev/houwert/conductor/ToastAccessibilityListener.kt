...
object ToastAccessibilityListener : UiAutomation.OnAccessibilityEventListener {
    ...
    override fun onAccessibilityEvent(accessibilityEvent: AccessibilityEvent) {
        if (
            ...
            toastNode = nodeInfo.apply {
                ...
                Log.d("Conductor", "Toast received with $text")
            }
        }
    }
    ...
    fun start(uiAutomation: UiAutomation): ToastAccessibilityListener {
        ...
        isListening = true
        Log.d("Conductor", "Started listening to accessibility events")
        return this
    }

    fun stop() {
        isListening = false
        Log.d("Conductor", "Stopped listening to accessibility events")
    }
}