...
import dev.houwert.conductor.handlers.LocaleSettingHandler
...
class LocaleSettingReceiver : BroadcastReceiver(), HasAction {
        ...
        if (language == null || country == null) {
            Log.w(
                TAG, "It is required to provide both language and country, for example: " +
                        "am broadcast -a dev.houwert.conductor --es lang ja --es country JP"
            )
    ...
    companion object {
        ...
        private const val ACTION = "dev.houwert.conductor.locale"
