...
- b4b88bb: Crop `take-screenshot` to an element on the inner panel of a foldable. The crop
...
- 1e2e737: Fix `take-screenshot --display`
...
- 3400bdf: Add fold control for foldable simulators and orientation read/write
...
- 5e77bc1: Support Xcode 27 alongside Xcode 26.
...
- 78081da: Add `conductor metro use` to point an app at a specific Metro
...
- 0bd6c0d: Add Roku support. Roku devices are driven over the network with the External
...
- f3dccaf: Corrections from release-build runs on a Fire TV Stick 4K Max.
...
- 0643699: Three corrections from a release-build run on a Fire TV Stick 4K Max.
